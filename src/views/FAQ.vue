<template>
  ...
  >
    ...
    >
      ...
      <v-card-text>
        <h2 class="pb-3">
          Staking / Unstaking / Delegating / Undelegating ?
        </h2>
        <p class="text-body-1 pl-9">
          ...
          By staking your tokens on a validator node you will help securing the Network
          and you will receive rewards.<br>
        </p>
        <h2 class="pb-3">
          Staking Rewards
        </h2>
        <p class="text-body-1 pl-9">
          Staking reward are payed every ERA (1 ERA is approximately 2 hours actually).<br>
          Once you have delegated your tokens you will receive the rewards at
          the end of the next ERA.<br>
          Actually there's no way to track easily the APY, but given the
          feedback from the community it's actually 20%~ (Per year).
        </p>
        <h2 class="pb-3">
          Unstaking Delay
        </h2>
        ...
        <p class="text-body-1 pl-9">
          ...
          Even if the Validator goes offline or is ejected from
          the auction you can unstake at any time.<br>
        </p>
        <h2 class="pb-3">
          Who are you ?
        </h2>
        <p class="text-body-1 pl-9">
          A member of the community ! You can find me on the Casper discord with this id :
          killian#7405<br>
        ...
        <p class="text-body-1 pl-9">
          Feel free to contact me on discord or through the contact page !
        </p>
      </v-card-text>
    </v-card>
  </v-container>
