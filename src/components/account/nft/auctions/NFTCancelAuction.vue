...
export default {
  ...
  data() {
    return {
      ...
      errorDeploy: null,
      operationType: NftCancelAuctionResult.getName(),
      bidFee: 15,
      loadingBalance: true,
    };
  },
  ...
  methods: {
     ...
     */
    async sendDeploy() {
      const deployParameter = new NftCancelAuction(
        this.activeKey,
        NETWORK,
