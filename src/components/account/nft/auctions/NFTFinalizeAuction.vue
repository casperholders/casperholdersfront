...
import { mdiAccountCircle, mdiFileSign } from '@mdi/js';
import { mapGetters, mapState } from 'vuex';

export default {
  name: 'NFTFinalizeAuction',
  ...
  data() {
    return {
      ...
      errorDeploy: null,
      operationType: NftFinalizeResult.getName(),
      bidFee: 30,
      loadingBalance: true,
    };
  },
  ...
  methods: {
     ...
     */
    async sendDeploy() {
      const deployParameter = new NftFinalize(
        this.activeKey,
        NETWORK,
